# [4.89.0] - 2026-08-27 13:44 WITA versionCode 187 ***ONGOING***
### ✨ Fitur Baru
...
### ✏️ File Changed
- 2026-08-27 13:44 — `BatteryHistoryDb.java` — Naikkan DB_VERSION ke 2; tambah tabel activity_log (time, status) + index; tambah method insertActivityLog() & queryActivityLog()
- 2026-08-27 13:44 — `BatteryMonitor.java` — Log status perubahan (screen on/off, charging) ke activity_log saat status berubah
- 2026-08-27 13:44 — `BatteryTimelineBarView.java` — Custom view baru: bar horizontal warna-warni menampilkan status aktivitas perangkat seiring waktu
- 2026-08-27 13:44 — `panel_battery.xml` — Tambah BatteryTimelineBarView + legenda warna (Mati/Aktif/Charging) di bawah grafik Persentase
- 2026-08-27 13:44 — `BatteryChartHistoryController.java` — Bind BatteryTimelineBarView, query activity_log saat refresh()
- 2026-08-27 13:08 — `TextModule.java` — Tambah setGravity(CENTER_HORIZONTAL) agar teks overlay rata tengah
- 2026-08-27 13:08 — `FpsModule.java` — Sama: tambah setGravity(CENTER_HORIZONTAL)
- 2026-08-27 13:08 — `BatteryStatsModule.java` — Sama: tambah setGravity(CENTER_HORIZONTAL)
- 2026-08-27 13:08 — `NetworkModule.java` — Sama: tambah setGravity(CENTER_HORIZONTAL)
- 2026-08-27 13:08 — `MemoryModule.java` — Sama: tambah setGravity(CENTER_HORIZONTAL)
- 2026-08-27 12:54 — `ClockModule.java` — Gunakan SpannableString dengan AbsoluteSizeSpan untuk ukuran tanggal terpisah; tambah method updateDateSize(); tambah setGravity(CENTER_HORIZONTAL)
- 2026-08-27 12:54 — `panel_clock.xml` — Tambah slider "Ukuran Tanggal" (clockDateSizeSeekBar, range 6–100) di bawah slider Ukuran Teks
- 2026-08-27 12:54 — `ClockPanelController.java` — Bind slider tanggal, load/save pref clock_date_size, listener + SliderLabelEditor
- 2026-08-27 12:54 — `ClockPositionController.java` — Save/load dateSize di preset + syncToService()
- 2026-08-27 12:54 — `OverlayPreset.java` — Tambah field dateSize
- 2026-08-27 12:54 — `MainActivity.java` — Load pref clock_size dan clock_date_size saat startup
- 2026-08-27 12:54 — `ClockConfig.java` — Tambah field dateSize = 10f
- 2026-08-27 12:41 — `BatteryChartView.java` — Tambah konstanta GAP_THRESHOLD_MS (5 menit) untuk deteksi gap waktu; memutus garis grafik saat jeda > 5 menit (ponsel mati/lama tidak aktif); ubah batas default grafik Suhu dari 33–43°C ke 35–40°C
- 2026-08-27 12:19 — `activity_battery_chart_detail.xml` — Ubah RadioGroup/RadioButton jadi LinearLayout/TextView teks button "Tracker Grafik"/"Geser Grafik"
- 2026-08-27 12:19 — `BatteryChartDetailActivity.java` — Hapus import RadioGroup/RadioButton; ganti binding ke TextView dengan click listener manual + logic warna aktif/nonaktif
- 2026-08-27 11:03 — `activity_battery_chart_detail.xml` — Tambah RadioGroup (Crosshair/Pan) di header + SeekBar zoom di antara chart dan label rentang
- 2026-08-27 11:19 — `activity_battery_chart_detail.xml` — Pindah baris label rentang ke atas grafik; slider zoom jadi full-width (hapus margin kiri/kanan)
- 2026-08-27 11:27 — `colors.xml` — Tambah bat_slider_thumb & bat_slider_track (tema terang)
- 2026-08-27 11:27 — `values-night/colors.xml` — Tambah bat_slider_thumb & bat_slider_track (tema gelap)
- 2026-08-27 11:27 — `activity_battery_chart_detail.xml` — Slider zoom: thumbTint → bat_slider_thumb, progressBackgroundTint → bat_slider_track (track terlihat)
- 2026-08-27 11:03 — `BatteryChartDetailActivity.java` — Bind RadioGroup ke chartView.setMode(), bind zoom SeekBar ke chartView.setZoomLevel(), reset zoom SeekBar saat rentang diganti
- 2026-08-27 09:40 — `BatteryHistoryDb.java` — Tambah method estimateTimeRemaining() untuk kalkulasi estimasi waktu penuh/habis dari laju sampel; tambah class ChargingSession & method queryChargingSessions() untuk analisis sesi pengisian dari data sampel mentah
- 2026-08-27 09:40 — `BatteryMonitorTabController.java` — Tampilkan "Est. Penuh" atau "Est. Habis" di grid metrik real-time berdasarkan status charging/discharging; tambah helper formatDuration() untuk format waktu ke jam/menit
- 2026-08-27 09:40 — `BatteryHealthCardController.java` — Tambah section riwayat 5 sesi pengisian terakhir (waktu, durasi, delta%, colokan) di kartu Kesehatan Baterai; query di-cache 30 detik agar tidak berat
- 2026-08-27 09:40 — `panel_battery.xml` — Tambah TextView batSessionHistoryText di kartu Kesehatan Baterai untuk menampilkan riwayat sesi pengisian
- 2026-08-27 01:46 — `old-CHANGELOG.md` — Entry v4.85.1–4.86.0 dipindah dari CHANGELOG.md
- 2026-08-27 01:36 — `BatteryHealthCardController.java` — Tambah kolom konfirmasi teks di dialog Reset agar tombol Reset hanya aktif jika user mengetik "RESET"

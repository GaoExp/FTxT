...
private void bindViews(View rootView) {
    ...
    btnMinus = rootView.findViewById(R.id.batbar_btnMinus);
    btnPlus = rootView.findViewById(R.id.batbar_btnPlus);
    ...
    dpadCenter = rootView.findViewById(R.id.batbar_dpadInterval);
}

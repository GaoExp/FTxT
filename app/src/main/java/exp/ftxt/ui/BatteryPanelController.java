...
public class BatteryPanelController {
    ...
    private BatteryMonitorTabController monitorTab;

    public BatteryPanelController(MainActivity activity, View rootView) {
        this.activity = activity;
        bindViews(rootView);
        monitorTab = new BatteryMonitorTabController(activity, rootView);
        loadConfig();
        setupListeners();
    ...
    public void onPanelShown() {
        ...
        monitorTab.onPanelShown();
    }

    public void onPanelHidden() {
        monitorTab.onPanelHidden();
    }

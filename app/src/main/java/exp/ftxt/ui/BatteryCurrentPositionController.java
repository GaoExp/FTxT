...
public class BatteryCurrentPositionController {
    ...
    private final PresetHandler.Delegate delegate = new PresetHandler.Delegate() {
        ...
        @Override
        public String moduleType() { return "batcur"; }
        @Override
        ...
        public void saveToPreset(OverlayPreset p) {
            ...
            p.bgEnabled = BatteryCurrentConfig.bg.enabled;
            p.bgColor = BatteryCurrentConfig.bg.color;
            p.bgPadding = BatteryCurrentConfig.bg.padding;
            p.bgOffsetX = BatteryCurrentConfig.bg.offsetX;
            p.bgOffsetY = BatteryCurrentConfig.bg.offsetY;
        ...
        public void applyFromPreset(Activity activity, OverlayPreset p, SharedPreferences prefs) {
            ...
            BatteryCurrentConfig.bg.enabled = p.bgEnabled;
            BatteryCurrentConfig.bg.color = p.bgColor;
            BatteryCurrentConfig.bg.padding = p.bgPadding;
            BatteryCurrentConfig.bg.offsetX = p.bgOffsetX;
            BatteryCurrentConfig.bg.offsetY = p.bgOffsetY;
            BatteryCurrentConfig.bg.margin = p.bgMargin;
            BatteryCurrentConfig.bg.radius = p.bgRadius;
    ...
    public BatteryCurrentPositionController(Activity activity, View rootView) {
        ...
        sliderController = new SliderPositionController(
                rootView.findViewById(R.id.batCurPosXSeekBar),
                rootView.findViewById(R.id.batCurPosYSeekBar),
                rootView.findViewById(R.id.batCurPosXLabel),
                rootView.findViewById(R.id.batCurPosYLabel),
    ...
    public void cleanup() {
        ...
        FloatingService.setOrientationSuffixForModule(FloatingService.batteryCurrentModule(), null);
    ...
    private void updateCoordDisplay() {
        ...
        int px, py;
        int[] pos = FloatingService.getCurrentPositionForModule(FloatingService.batteryCurrentModule());
        if (pos != null) {
            px = pos[0];
            py = pos[1];
        } else {

...
public class FloatingService extends Service {
    ...
    private void applyShadow(){
        ...
        if(shadowEnabled){
            ...
            int bgColor = 0x88000000; // alpha + black
            floatingView.setBackgroundColor(bgColor);
            // optional: set elevation/shadow on supported APIs
        ...
        // update layout in case padding/background changed
    ...
    public void onCreate() {
        ...
        try {
            ...
            // apply initial shadow/background state
            applyShadow();

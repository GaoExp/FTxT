...
4. `cp *.md app/src/main/assets/` jika tidak build
...
### Setelah Push (entry versi baru)
1. versionCode +1
2. versionName sesuai Algoritma Increment (major.minor.patch)
3. buat entry CHANGELOG baru (paling atas)
